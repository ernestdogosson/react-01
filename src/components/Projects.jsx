...
function Project({
  ...
  return (
    <>
      <div className="h-[480px] shadow-xl rounded-xl border border-gray-300 p-6 flex flex-col justify-end hover:scale-105 hover:-translate-y-2 hover:shadow-2xl transition-all duration-300 ease-out cursor-pointer relative group overflow-hidden">
        <div
        ...
        ></div>
        <div className="absolute inset-0 bg-gradient-to-t from-black via-black/50 to-black/30 opacity-60 group-hover:opacity-95 transition-all duration-300 z-10"></div>
